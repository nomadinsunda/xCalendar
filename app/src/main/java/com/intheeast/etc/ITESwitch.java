...
public class ITESwitch extends CompoundButton {
	...
	// left and right text
		 ...
		 */
		public ITESwitch(Context context)
		{
			this(context, null);
		}
		 ...
		 */
		public ITESwitch(Context context, AttributeSet attrs)
		{
		...
		public ITESwitch(Context context, AttributeSet attrs, int defStyle)
		{
			...
			TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.CustomSwitchView, defStyle, 0);
			this.textLeft = a.getText(R.styleable.CustomSwitchView_textLeft);
			this.textRight = a.getText(R.styleable.CustomSwitchView_textRight);
			this.textColorUnChecked = a.getColor(R.styleable.CustomSwitchView_colorUnChecked, Color.WHITE);
			this.textColorChecked = a.getColor(R.styleable.CustomSwitchView_colorChecked, Color.WHITE);
			this.drawableBackground = a.getDrawable(R.styleable.CustomSwitchView_backgroundDrawable);
			this.drawableSwitch = a.getDrawable(R.styleable.CustomSwitchView_switchDrawable);
			
			this.switchMinWidth = a.getDimensionPixelSize(R.styleable.CustomSwitchView_switchMinWidth, 250);			
			this.switchPadding = a.getDimensionPixelSize(R.styleable.CustomSwitchView_switchPadding, 32);
			this.innerPadding = a.getDimensionPixelSize(R.styleable.CustomSwitchView_innerPadding, 20);
			
			this.setChecked(a.getBoolean(R.styleable.CustomSwitchView_isChecked, false));
			a.recycle();
		...
		public ITESwitch(Context context, CharSequence leftText, CharSequence rightText,
				int textColorUnChecked, int textColorChecked,
				Drawable drawableBackground, Drawable drawableSwitch)
		{
			super(context);
			...
			this.drawableSwitch = drawableSwitch;
			
			this.switchMinWidth = 250;
			this.switchPadding = 32;			
		...
		protected void onDraw(Canvas canvas)
		{
			...
			if (this.isChecked()) {
				...
				this.drawableSwitch.setBounds(left + halfWidth, 0, right, this.height);
			}
