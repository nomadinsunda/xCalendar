...
public class EOverScroller {
     ...
     * @param context
     */
    public EOverScroller(Context context) {
        this(context, null);
    }
    ...
    public double getCurrVelocity() {
        double squaredNorm = mScrollerX.mCurrVelocity * mScrollerX.mCurrVelocity;
    ...
    public double calDistanceY(int velocity) {
    	return mScrollerY.getSplineFlingDistance(velocity);
    }
    
    public int calVelocityY(int distance) {
    	return mScrollerY.getSplineFlingAbsVelocity(distance);
    }
    
    public void extendDistanceY(int distance) {
        mScrollerY.extendDistance(distance);
    }
    ...
    static class SplineOverScroller {
        ...
        void extendDistance(int distance) {
        	// mFinal = start + mSplineDistance;
        	//int start = mFinal - mSplineDistance;
        	mSplineDistance = mSplineDistance + distance;
        ...
        void fling(int start, int velocity, int min, int max, int over) {
            ...
            // 스플라인 곡선(spline curve)은 주어진 복수의 제어점을 통과하는 부드러운 곡선으로, 인접한 두 점 사이에의 구간마다 별도의 다항식을 이용해 곡선을 정의한다. 스플라인은 금속이나 나무로 된 가늘고 긴 자를 뜻한다. 
            // 스플라인은 탄력이 있어 자유롭게 변형되는 곡선을 만들 수 있어, 자연스러운 곡선을 그리는 데 이용된다.
