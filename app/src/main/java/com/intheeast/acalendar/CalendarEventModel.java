...
public class CalendarEventModel implements Serializable {
    ...
    public static class Attendee implements Serializable {
        ...
        public int mID;
        public int mRelationShip;//ATTENDEES_INDEX_RELATIONSHIP
        ...
        public Attendee(int id, String name, String email, int status, String identity,
                String idNamespace, int relationShip) {
        	mID = id;
            mName = name;
            mEmail = email;
            mStatus = status;
    ...
    //public SpannableStringBuilder mCalendarNameSB = null; // Serializable를 implements 하지 않았기 때문에 사용할 수 없다
    ...
    public CalendarEventModel(Context context) {
        ...
        if (defaultReminderMins != SettingsFragment.NO_REMINDER) {   
        	// 코드는 살려놨다만 이 따위 짓을 할 필요가 있을까???
