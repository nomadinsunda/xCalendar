...
import com.intheeast.acalendar.AsyncQueryService.Operation;

public class AsyncQueryServiceSupporter extends IntentService {
    ...
    static public void queueOperation(Context context, OperationInfo args) {
        ...
        ComponentName cpName = context.startService(new Intent(context, AsyncQueryServiceSupporter.class));
        //Log.i("tag", "queueOperation:cpName=" + cpName.toString());
    }
    ...
    public AsyncQueryServiceSupporter(String name) {
        super(name);
    }

    public AsyncQueryServiceSupporter() {
