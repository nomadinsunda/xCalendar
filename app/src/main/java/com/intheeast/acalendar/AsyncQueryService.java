...
import com.intheeast.acalendar.AsyncQueryServiceSupporter.OperationInfo;
...
public class AsyncQueryService extends Handler {
    ...
    public final Operation getLastCancelableOperation() {
        return AsyncQueryServiceSupporter.getLastCancelableOperation();
    }
    ...
    public final int cancelOperation(int token) {
        return AsyncQueryServiceSupporter.cancelOperation(token);
    }
    ...
    public void startQuery(int token, Object cookie, Uri uri, String[] projection,
        ...
        AsyncQueryServiceSupporter.queueOperation(mContext, info);
    }
