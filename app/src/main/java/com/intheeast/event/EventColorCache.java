...
public class EventColorCache implements Serializable {
    ...
    public Map<String, ArrayList<Integer>> getColorPaletteMap() {
    	return mColorPaletteMap;
    }
    
    public Map<String, Integer> getColorKeyMap() {
    	return mColorKeyMap;
    }
    
    public void setColorPaletteMap(Map<String, ArrayList<Integer>> map) {
    	mColorPaletteMap = map;
    }
    
    public void setColorKeyMap(Map<String, Integer> map) {
    	mColorKeyMap = map;
    }
