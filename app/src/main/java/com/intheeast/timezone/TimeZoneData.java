...
public class TimeZoneData {
    ...
    void loadTzs(Context context) {
        ...
        for (TimeZoneInfo tz : mTimeZones) {
            ...
            if (tz.mDisplayName == null) {
                tz.mDisplayName = tz.mTimeZone.getDisplayName(tz.mTimeZone.inDaylightTime(date),
    ...
    private void printTimeZones() {
        ...
        for (TimeZoneInfo tz : mTimeZones) {
            ...
            // GMT
            if (true) {
                String name = tz.mTimeZone.getDisplayName();
        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (!line.startsWith("#") && line.length() > 0) {
                    ...
                    // 1: New tz id
                    // Last: Old tz id
                    String[] fields = line.split("\t+"); // horizontal tab �� �� �̻� ---> \t+
