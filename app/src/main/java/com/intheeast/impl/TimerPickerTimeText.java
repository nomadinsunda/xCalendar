...
public class TimerPickerTimeText {
	...
	/*
	public TimerPickerTimeText(Calendar time, boolean allDay) {
		mAllDayTime = allDay;
		
		Calendar targetCalendar = (Calendar)Calendar.getInstance();
		targetCalendar.setTimeZone(TimeZone.getTimeZone(time.timezone));
		targetCalendar.setTimeInMillis(time.toMillis(true));
	...
	*/
	...
	/*
	public boolean makeTimeTextByOtherCompare(Time compareTime) {
		boolean sameDate = false;
		
		int compareYear = compareTime.year;
		int compareMonth = transformMonthToRealNumber(compareTime.month);
		int compareDate = compareTime.monthDay;
