...
public class AlertUtils {
    ...
    public static final long SNOOZE_DELAY_FORTEST = 1 * 60 * 1000L;
        ...
        return new AlarmManagerInterface() {
            ...
            public void set(int type, long triggerAtMillis, PendingIntent operation) {
                ...
                */ // +commented by intheeast
            	...
            	mgr.set(type, triggerAtMillis, operation); // +modified by intheeast
            }
        };
    }
    ...
    private static void scheduleAlarmHelper(Context context, AlarmManagerInterface manager,
        ...
        // PendingIntent.FLAG_UPDATE_CURRENT : �̹� ������ PendingIntent �� �����ϸ� �ش� Intent �� ������ �����Ѵ�
    ...
    static String formatTimeLocation(Context context, long startMillis, boolean allDay,
        ...
        //long gmtoff = timezone.getRawOffset() / 1000;
        Calendar time = GregorianCalendar.getInstance(timezone);//Time time = new Time(tz);
        
        time.setTimeInMillis(System.currentTimeMillis());        
        int today = ETime.getJulianDay(time.getTimeInMillis(), timezone, firstDayOfWeek);
        time.setTimeInMillis(startMillis);
        if (allDay) {
        	timezone = TimeZone.getTimeZone("UTC");
        }
        int eventDay = ETime.getJulianDay(time.getTimeInMillis(), timezone, firstDayOfWeek);
    ...
    static void flushOldAlertsFromInternalStorage(Context context) {
        if (BYPASS_DB) {
            ...
            if (nowTime - lastFlushTimeMs > FLUSH_INTERVAL_MS) {
                ...
                SharedPreferences.Editor editor = prefs.edit();
                Calendar timeObj = GregorianCalendar.getInstance();
